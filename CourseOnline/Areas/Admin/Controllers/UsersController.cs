...
namespace CourseOnline.Areas.Admin.Controllers
{
    public class UsersController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,UserName,Password,RoleId,FullName,Email,Phone,Avatar,DateOfBirth,Gender,Address,Status,CreatedAt,UpdatedAt")] User user)
        {
            if (ModelState.IsValid)
            {
